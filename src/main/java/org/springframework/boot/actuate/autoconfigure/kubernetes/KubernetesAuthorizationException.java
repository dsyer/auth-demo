 ...
 * @since 2.0.0
 */
public class KubernetesAuthorizationException extends RuntimeException {

	private final Reason reason;

	public KubernetesAuthorizationException(Reason reason, String message) {
		this(reason, message, null);
	}

	public KubernetesAuthorizationException(Reason reason, String message, Throwable cause) {
		super(message, cause);
		this.reason = reason;
	}
