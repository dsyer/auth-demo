 ...
 * {@link KubernetesWebEndpointDiscoverer}.
 *
 * @author Madhura Bhave
 */
class KubernetesEndpointFilter extends DiscovererEndpointFilter {

	protected KubernetesEndpointFilter() {
		super(KubernetesWebEndpointDiscoverer.class);
	}
