...
import org.springframework.boot.actuate.autoconfigure.kubernetes.EndpointKubernetesExtension;
 ...
 * @since 2.0.0
 */
@EndpointKubernetesExtension(endpoint = HealthEndpoint.class)
public class KubernetesHealthEndpointWebExtension {

	private final HealthEndpointWebExtension delegate;

	public KubernetesHealthEndpointWebExtension(HealthEndpointWebExtension delegate) {
